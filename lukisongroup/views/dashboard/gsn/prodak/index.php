...
$this->sideMenu = 'gsn_prodak';                                       /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'Gosend - Product Dashboard');            /* title pada header page */
